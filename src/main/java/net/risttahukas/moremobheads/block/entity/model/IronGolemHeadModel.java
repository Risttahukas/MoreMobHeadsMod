...
@OnlyIn(Dist.CLIENT)
public class IronGolemHeadModel extends SkullModel {
    protected final ModelPart nose;

    public IronGolemHeadModel(ModelPart modelPart) {
        super(modelPart);
        this.nose = modelPart.getChild("head").getChild("nose");
    }

    public static MeshDefinition createIronGolemHeadModel() {
    ...
    public static LayerDefinition createIronGolemHeadLayer() {
        MeshDefinition meshdefinition = createIronGolemHeadModel();
