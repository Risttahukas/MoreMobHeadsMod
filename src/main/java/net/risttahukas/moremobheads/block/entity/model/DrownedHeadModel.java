...
@OnlyIn(Dist.CLIENT)
public class DrownedHeadModel extends SkullModel {
    private static final ResourceLocation DROWNED_CLOTHES_LOCATION = new ResourceLocation("textures/entity/zombie/drowned_outer_layer.png");
    private final ModelPart rootClothes;
    protected final ModelPart headClothes;

    public DrownedHeadModel(ModelPart skinModelPart, ModelPart clothesModelPart) {
        super(skinModelPart);
        this.rootClothes = clothesModelPart;
        this.headClothes = clothesModelPart.getChild("head");
    }

    public static MeshDefinition createDrownedHeadClothesModel() {
    ...
    public static LayerDefinition createDrownedHeadClothesLayer() {
        MeshDefinition meshdefinition = createDrownedHeadClothesModel();
    ...
    public void renderToBuffer(@NotNull PoseStack poseStack, @NotNull VertexConsumer vertexConsumer, MultiBufferSource multiBufferSource, int p_103817_, int p_103818_, float p_103819_, float p_103820_, float p_103821_, float p_103822_) {
        ...
        VertexConsumer clothesVertexConsumer = multiBufferSource.getBuffer(RenderType.entityCutoutNoCullZOffset(DROWNED_CLOTHES_LOCATION));
