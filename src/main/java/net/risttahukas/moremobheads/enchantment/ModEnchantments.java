...
public class ModEnchantments {
    public static final DeferredRegister<Enchantment> ENCHANTMENTS =
            DeferredRegister.create(ForgeRegistries.ENCHANTMENTS, MoreMobHeadsMod.MOD_ID);

    public static final RegistryObject<Enchantment> BEHEADING = ENCHANTMENTS.register("beheading",  () ->
            new BeheadingEnchantment(Enchantment.Rarity.VERY_RARE, ModEnchantmentCategory.AXE, EquipmentSlot.MAINHAND)) ;
