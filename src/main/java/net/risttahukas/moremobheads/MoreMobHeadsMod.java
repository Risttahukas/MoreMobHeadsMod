...
public class MoreMobHeadsMod
{
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        if (event.getTab() == ModCreativeModeTabs.MOB_HEADS_TAB.get()) {
            ...
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_DESERT_ARMORER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_DESERT_BUTCHER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_DESERT_CARTOGRAPHER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_DESERT_CLERIC);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_DESERT_FARMER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_DESERT_FISHERMAN);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_DESERT_FLETCHER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_DESERT_LEATHERWORKER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_DESERT_LIBRARIAN);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_DESERT_MASON);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_DESERT_SHEPHERD);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_DESERT_TOOLSMITH);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_DESERT_WEAPONSMITH);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_DESERT_NITWIT);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_JUNGLE);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_JUNGLE_ARMORER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_JUNGLE_BUTCHER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_JUNGLE_CARTOGRAPHER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_JUNGLE_CLERIC);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_JUNGLE_FARMER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_JUNGLE_FISHERMAN);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_JUNGLE_FLETCHER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_JUNGLE_LEATHERWORKER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_JUNGLE_LIBRARIAN);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_JUNGLE_MASON);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_JUNGLE_SHEPHERD);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_JUNGLE_TOOLSMITH);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_JUNGLE_WEAPONSMITH);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_JUNGLE_NITWIT);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_PLAINS);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_PLAINS_ARMORER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_PLAINS_BUTCHER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_PLAINS_CARTOGRAPHER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_PLAINS_CLERIC);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_PLAINS_FARMER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_PLAINS_FISHERMAN);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_PLAINS_FLETCHER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_PLAINS_LEATHERWORKER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_PLAINS_LIBRARIAN);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_PLAINS_MASON);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_PLAINS_SHEPHERD);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_PLAINS_TOOLSMITH);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_PLAINS_WEAPONSMITH);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_PLAINS_NITWIT);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SAVANNA);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SAVANNA_ARMORER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SAVANNA_BUTCHER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SAVANNA_CARTOGRAPHER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SAVANNA_CLERIC);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SAVANNA_FARMER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SAVANNA_FISHERMAN);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SAVANNA_FLETCHER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SAVANNA_LEATHERWORKER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SAVANNA_LIBRARIAN);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SAVANNA_MASON);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SAVANNA_SHEPHERD);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SAVANNA_TOOLSMITH);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SAVANNA_WEAPONSMITH);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SAVANNA_NITWIT);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SNOW);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SNOW_ARMORER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SNOW_BUTCHER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SNOW_CARTOGRAPHER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SNOW_CLERIC);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SNOW_FARMER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SNOW_FISHERMAN);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SNOW_FLETCHER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SNOW_LEATHERWORKER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SNOW_LIBRARIAN);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SNOW_MASON);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SNOW_SHEPHERD);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SNOW_TOOLSMITH);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SNOW_WEAPONSMITH);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SNOW_NITWIT);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SWAMP);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SWAMP_ARMORER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SWAMP_BUTCHER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SWAMP_CARTOGRAPHER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SWAMP_CLERIC);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SWAMP_FARMER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SWAMP_FISHERMAN);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SWAMP_FLETCHER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SWAMP_LEATHERWORKER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SWAMP_LIBRARIAN);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SWAMP_MASON);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SWAMP_SHEPHERD);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SWAMP_TOOLSMITH);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SWAMP_WEAPONSMITH);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_SWAMP_NITWIT);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_TAIGA);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_TAIGA_ARMORER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_TAIGA_BUTCHER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_TAIGA_CARTOGRAPHER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_TAIGA_CLERIC);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_TAIGA_FARMER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_TAIGA_FISHERMAN);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_TAIGA_FLETCHER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_TAIGA_LEATHERWORKER);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_TAIGA_LIBRARIAN);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_TAIGA_MASON);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_TAIGA_SHEPHERD);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_TAIGA_TOOLSMITH);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_TAIGA_WEAPONSMITH);
            event.accept(ModItems.ZOMBIE_VILLAGER_HEAD_TAIGA_NITWIT);
