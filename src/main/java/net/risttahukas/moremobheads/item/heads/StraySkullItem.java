...
public class StraySkullItem extends EffectSkullItem {
    public StraySkullItem(Block skull, Block wallSkull, Properties properties, Direction direction) {
    ...
    public ImmutableList<AbstractPassiveHeadEffect> getPassiveHeadEffects() {
        if (MoreMobHeadsModCommonConfigs.ENABLE_PASSIVE_HEAD_EFFECTS.get() && MoreMobHeadsModCommonConfigs.ENABLE_STRAY_SKULL_EFFECTS.get()) {
