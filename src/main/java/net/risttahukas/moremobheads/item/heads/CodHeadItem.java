...
public class CodHeadItem extends AbstractFishHeadItem {
    ...
    public SoundEvent getSound() {
        return ModSoundEvents.NOTE_BLOCK_IMITATE_COD.get();
    }

    @Override
    public ImmutableList<AbstractPassiveHeadEffect> getPassiveHeadEffects() {
        if (MoreMobHeadsModCommonConfigs.ENABLE_PASSIVE_HEAD_EFFECTS.get() && MoreMobHeadsModCommonConfigs.ENABLE_COD_HEAD_EFFECTS.get()) {
