...
public class TropicalFishHeadItem extends EffectSkullItem {
    public TropicalFishHeadItem(Block skull, Block wallSkull, Properties properties, Direction direction) {
