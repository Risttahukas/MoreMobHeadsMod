...
public class GlowSquidHeadItem extends SquidHeadItem {
    ...
    public SoundEvent getSound() {
        return ModSoundEvents.NOTE_BLOCK_IMITATE_GLOW_SQUID.get();
    }

    @Override
    public ImmutableList<AbstractPassiveHeadEffect> getPassiveHeadEffects() {
        if (MoreMobHeadsModCommonConfigs.ENABLE_PASSIVE_HEAD_EFFECTS.get() && MoreMobHeadsModCommonConfigs.ENABLE_GLOW_SQUID_HEAD_EFFECTS.get()) {
