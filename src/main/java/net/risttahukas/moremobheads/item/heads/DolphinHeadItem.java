...
public class DolphinHeadItem extends EffectSkullItem {
    ...
    public ImmutableList<AbstractPassiveHeadEffect> getPassiveHeadEffects() {
        if (MoreMobHeadsModCommonConfigs.ENABLE_PASSIVE_HEAD_EFFECTS.get() && MoreMobHeadsModCommonConfigs.ENABLE_DOLPHIN_HEAD_EFFECTS.get()) {
            return ImmutableList.of(HeadEffects.AMPHIBIAN, HeadEffects.DOLPHIN_SPEED);
        }
