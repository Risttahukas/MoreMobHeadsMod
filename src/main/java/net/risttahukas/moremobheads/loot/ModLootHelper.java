package net.risttahukas.moremobheads.loot;
...
public class ModLootHelper {
    public static Item getHeadFromMob(LivingEntity entity) {
        ...
        if (entity instanceof Allay) {
            ...
            if (creeper.isPowered()) {
                headToDrop = ModItems.CREEPER_HEAD_CHARGED.get();
            } else {
                headToDrop = Items.CREEPER_HEAD;
            }
            ...
            headToDrop = Items.SKELETON_SKULL;
            ...
            headToDrop = Items.WITHER_SKELETON_SKULL;
        ...
        } else if (entity instanceof Zombie && !(entity instanceof ZombieVillager) && !(entity instanceof ZombifiedPiglin)) {
            headToDrop = Items.ZOMBIE_HEAD;
    ...
    public static float getHeadDropChance(LivingEntity entity, int lootingLevel, int beheadingLevel) {
        ...
        if (entity instanceof WitherBoss) {
            beheadingMultiplier = 0.2F;
        }
        return baseChance + lootingMultiplier * lootingLevel + beheadingMultiplier * beheadingLevel;
    }
}
